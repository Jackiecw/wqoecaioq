...
const metricRoutes_1 = __importDefault(require("./metricRoutes"));
const advertisingRoutes_1 = __importDefault(require("./advertisingRoutes"));
const trafficRoutes_1 = __importDefault(require("./trafficRoutes"));
function registerRoutes(app) {
    ...
    app.use('/api/admin/metrics', metricRoutes_1.default);
